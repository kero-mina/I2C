...
// Hierarchy delimiter:'/'
// Write Command : write_verilog ./output_pnr/i2c_master_top_icc_nopg.v -no_physical_only_cells
//
...
module i2c_master_bit_ctrl (dout , scl_o , scl_oen , sda_o , sda_oen , 
    nReset_hfs_netlink_0 , din , scl_i , sda_i , VDD , VSS , cmd_ack , 
    busy , al , cmd , clk , rst , nReset , ena , clk_cnt , 
    nReset_hfs_netlink_1 , nReset_hfs_netlink_2 , nReset_hfs_netlink_3 , 
    rst_hfs_netlink_4 , rst_hfs_netlink_5 , rst_hfs_netlink_6 , 
    rst_hfs_netlink_7 );
output dout ;
output scl_o ;
output scl_oen ;
...
CLKBUF_X1 U296 (.A ( nReset_hfs_netlink_0 ) , .Z ( n420 ) ) ;
CLKBUF_X1 U295 (.A ( nReset_hfs_netlink_0 ) , .Z ( n419 ) ) ;
CLKBUF_X1 U294 (.A ( n377 ) , .Z ( n418 ) ) ;
CLKBUF_X1 U293 (.A ( nReset ) , .Z ( n417 ) ) ;
CLKBUF_X1 U292 (.A ( nReset ) , .Z ( n416 ) ) ;
CLKBUF_X1 U291 (.A ( n376 ) , .Z ( n415 ) ) ;
CLKBUF_X1 U290 (.A ( n377 ) , .Z ( n414 ) ) ;
CLKBUF_X1 U289 (.A ( n376 ) , .Z ( n413 ) ) ;
CLKBUF_X1 U288 (.A ( n377 ) , .Z ( n412 ) ) ;
CLKBUF_X1 U287 (.A ( n377 ) , .Z ( n411 ) ) ;
CLKBUF_X1 U286 (.A ( n376 ) , .Z ( n409 ) ) ;
CLKBUF_X1 U285 (.A ( n376 ) , .Z ( n408 ) ) ;
CLKBUF_X1 U284 (.A ( rst_hfs_netlink_6 ) , .Z ( n407 ) ) ;
CLKBUF_X1 U283 (.A ( rst_hfs_netlink_5 ) , .Z ( n406 ) ) ;
CLKBUF_X1 U282 (.A ( rst_hfs_netlink_5 ) , .Z ( n405 ) ) ;
CLKBUF_X1 U281 (.A ( rst_hfs_netlink_5 ) , .Z ( n404 ) ) ;
CLKBUF_X1 U280 (.A ( rst_hfs_netlink_5 ) , .Z ( n403 ) ) ;
CLKBUF_X1 U267 (.A ( nReset_hfs_netlink_1 ) , .Z ( n402 ) ) ;
CLKBUF_X1 U266 (.A ( n378 ) , .Z ( n401 ) ) ;
CLKBUF_X1 U265 (.A ( n378 ) , .Z ( n400 ) ) ;
CLKBUF_X1 U260 (.A ( n378 ) , .Z ( n399 ) ) ;
CLKBUF_X1 U259 (.A ( nReset_hfs_netlink_1 ) , .Z ( n398 ) ) ;
INV_X1 U258 (.A ( n7 ) , .ZN ( n397 ) ) ;
INV_X1 U257 (.A ( n7 ) , .ZN ( n396 ) ) ;
INV_X1 U256 (.A ( n7 ) , .ZN ( n395 ) ) ;
INV_X1 U255 (.A ( n970 ) , .ZN ( n394 ) ) ;
INV_X1 U253 (.A ( n970 ) , .ZN ( n393 ) ) ;
INV_X1 U252 (.A ( n970 ) , .ZN ( n392 ) ) ;
INV_X1 U251 (.A ( n3 ) , .ZN ( n391 ) ) ;
INV_X1 U249 (.A ( n3 ) , .ZN ( n390 ) ) ;
INV_X1 U248 (.A ( n3 ) , .ZN ( n389 ) ) ;
INV_X1 U247 (.A ( n990 ) , .ZN ( n388 ) ) ;
INV_X1 U246 (.A ( n990 ) , .ZN ( n387 ) ) ;
INV_X1 U245 (.A ( n990 ) , .ZN ( n386 ) ) ;
INV_X1 U244 (.A ( n8 ) , .ZN ( n385 ) ) ;
INV_X1 U243 (.A ( n8 ) , .ZN ( n384 ) ) ;
INV_X1 U242 (.A ( n8 ) , .ZN ( n383 ) ) ;
INV_X1 U241 (.A ( n375 ) , .ZN ( n382 ) ) ;
INV_X1 U239 (.A ( n375 ) , .ZN ( n381 ) ) ;
INV_X1 U238 (.A ( n101 ) , .ZN ( n379 ) ) ;
CLKBUF_X1 U237 (.A ( nReset_hfs_netlink_1 ) , .Z ( n378 ) ) ;
CLKBUF_X1 U235 (.A ( nReset ) , .Z ( n377 ) ) ;
CLKBUF_X1 U234 (.A ( nReset ) , .Z ( n376 ) ) ;
CLKBUF_X1 U233 (.A ( n101 ) , .Z ( n375 ) ) ;
CLKBUF_X1 U232 (.A ( n384 ) , .Z ( n374 ) ) ;
INV_X1 U223 (.A ( n375 ) , .ZN ( n367 ) ) ;
INV_X1 U228 (.A ( n8 ) , .ZN ( n372 ) ) ;
INV_X1 U225 (.A ( n990 ) , .ZN ( n368 ) ) ;
INV_X1 U227 (.A ( n3 ) , .ZN ( n371 ) ) ;
INV_X1 U226 (.A ( n970 ) , .ZN ( n369 ) ) ;
INV_X1 U230 (.A ( n7 ) , .ZN ( n373 ) ) ;
CLKBUF_X1 U222 (.A ( n378 ) , .Z ( n366 ) ) ;
BUF_X2 U300 (.A ( clk ) , .Z ( n294 ) ) ;
BUF_X2 U299 (.A ( clk ) , .Z ( n293 ) ) ;
BUF_X32 U298 (.A ( n80 ) , .Z ( n292 ) ) ;
BUF_X32 U297 (.A ( n80 ) , .Z ( n291 ) ) ;
BUF_X1 U279 (.A ( n291 ) , .Z ( n169 ) ) ;
BUF_X1 U278 (.A ( n291 ) , .Z ( n168 ) ) ;
BUF_X1 U277 (.A ( n291 ) , .Z ( n167 ) ) ;
BUF_X1 U276 (.A ( n292 ) , .Z ( n166 ) ) ;
BUF_X1 U275 (.A ( n292 ) , .Z ( n165 ) ) ;
BUF_X1 U274 (.A ( n291 ) , .Z ( n164 ) ) ;
BUF_X1 U273 (.A ( n293 ) , .Z ( n163 ) ) ;
BUF_X1 U272 (.A ( n293 ) , .Z ( n161 ) ) ;
BUF_X1 U271 (.A ( n294 ) , .Z ( n160 ) ) ;
BUF_X1 U270 (.A ( n293 ) , .Z ( n159 ) ) ;
BUF_X1 U269 (.A ( n293 ) , .Z ( n158 ) ) ;
BUF_X1 U268 (.A ( n294 ) , .Z ( n157 ) ) ;
BUF_X1 U264 (.A ( n294 ) , .Z ( n133 ) ) ;
BUF_X1 U263 (.A ( n87 ) , .Z ( n128 ) ) ;
BUF_X1 U262 (.A ( n294 ) , .Z ( n126 ) ) ;
BUF_X1 U261 (.A ( n87 ) , .Z ( n125 ) ) ;
NOR2_X1 U254 (.A1 ( n131 ) , .A2 ( n407 ) , .ZN ( n115 ) ) ;
NAND4_X1 U250 (.A1 ( ena ) , .A2 ( n108 ) , .A3 ( n109 ) , .A4 ( n406 ) 
    , .ZN ( n101 ) ) ;
INV_X1 U240 (.A ( n870 ) , .ZN ( n910 ) ) ;
BUF_X2 U236 (.A ( clk ) , .Z ( n87 ) ) ;
CLKBUF_X1 U231 (.A ( n870 ) , .Z ( n82 ) ) ;
BUF_X32 U229 (.A ( clk ) , .Z ( n80 ) ) ;
BUF_X1 U3 (.A ( n87 ) , .Z ( n37 ) ) ;
BUF_X1 U1 (.A ( n292 ) , .Z ( n39 ) ) ;
BUF_X1 U2 (.A ( n292 ) , .Z ( n38 ) ) ;
INV_X1 U224 (.A ( n82 ) , .ZN ( n73 ) ) ;
NAND2_X1 U148 (.A1 ( N90 ) , .A2 ( n388 ) , .ZN ( n1260 ) ) ;
OAI21_X1 U149 (.A ( n127 ) , .B1 ( n269 ) , .B2 ( n393 ) , .ZN ( N103 ) ) ;
NAND2_X1 U150 (.A1 ( N89 ) , .A2 ( n387 ) , .ZN ( n127 ) ) ;
OAI21_X1 U151 (.A ( n1000 ) , .B1 ( n274 ) , .B2 ( n392 ) , .ZN ( N98 ) ) ;
NAND2_X1 U152 (.A1 ( N84 ) , .A2 ( n368 ) , .ZN ( n1000 ) ) ;
OAI21_X1 U153 (.A ( n10100 ) , .B1 ( n275 ) , .B2 ( n392 ) , .ZN ( N97 ) ) ;
NAND2_X1 U154 (.A1 ( N83 ) , .A2 ( n386 ) , .ZN ( n10100 ) ) ;
OAI21_X1 U155 (.A ( n1020 ) , .B1 ( n276 ) , .B2 ( n369 ) , .ZN ( N96 ) ) ;
NAND2_X1 U156 (.A1 ( N821 ) , .A2 ( n368 ) , .ZN ( n1020 ) ) ;
OAI21_X1 U157 (.A ( n1030 ) , .B1 ( n277 ) , .B2 ( n369 ) , .ZN ( N95 ) ) ;
NAND2_X1 U158 (.A1 ( N81 ) , .A2 ( n386 ) , .ZN ( n1030 ) ) ;
OAI21_X1 U159 (.A ( n1040 ) , .B1 ( n278 ) , .B2 ( n369 ) , .ZN ( N94 ) ) ;
NAND2_X1 U161 (.A1 ( N800 ) , .A2 ( n368 ) , .ZN ( n1040 ) ) ;
OAI21_X1 U162 (.A ( n105 ) , .B1 ( n279 ) , .B2 ( n369 ) , .ZN ( N93 ) ) ;
NAND2_X1 U164 (.A1 ( N79 ) , .A2 ( n368 ) , .ZN ( n105 ) ) ;
OAI21_X1 U166 (.A ( n106 ) , .B1 ( n280 ) , .B2 ( n393 ) , .ZN ( N92 ) ) ;
NAND2_X1 U169 (.A1 ( N78 ) , .A2 ( n387 ) , .ZN ( n106 ) ) ;
OAI21_X1 U170 (.A ( n130 ) , .B1 ( n272 ) , .B2 ( n392 ) , .ZN ( N100 ) ) ;
NAND2_X1 U171 (.A1 ( N86 ) , .A2 ( n386 ) , .ZN ( n130 ) ) ;
OAI21_X1 U172 (.A ( n850 ) , .B1 ( n206 ) , .B2 ( n860 ) , .ZN ( n243 ) ) ;
INV_X1 U173 (.A ( cmd[2] ) , .ZN ( n266 ) ) ;
OAI21_X1 U174 (.A ( n59 ) , .B1 ( n197 ) , .B2 ( n340 ) , .ZN ( n231 ) ) ;
NOR2_X1 U175 (.A1 ( cmd[1] ) , .A2 ( n391 ) , .ZN ( n61 ) ) ;
...
AND4_X1 U188 (.A1 ( n405 ) , .A2 ( n152 ) , .A3 ( n151 ) , .A4 ( n190 ) 
    , .ZN ( N1261 ) ) ;
AND2_X1 U189 (.A1 ( n117 ) , .A2 ( rst ) , .ZN ( N1330 ) ) ;
...
AOI22_X1 U59 (.A1 ( N42 ) , .A2 ( n396 ) , .B1 ( n385 ) , .B2 ( cnt[8] ) 
    , .ZN ( n290 ) ) ;
NOR2_X1 U60 (.A1 ( n131 ) , .A2 ( n407 ) , .ZN ( n870 ) ) ;
...
NAND2_X1 U67 (.A1 ( N88 ) , .A2 ( n388 ) , .ZN ( n1280 ) ) ;
OAI21_X1 U68 (.A ( n129 ) , .B1 ( n271 ) , .B2 ( n393 ) , .ZN ( N1010 ) ) ;
NAND2_X1 U69 (.A1 ( N871 ) , .A2 ( n387 ) , .ZN ( n129 ) ) ;
OAI21_X1 U71 (.A ( n980 ) , .B1 ( n273 ) , .B2 ( n392 ) , .ZN ( N99 ) ) ;
NAND2_X1 U72 (.A1 ( N85 ) , .A2 ( n386 ) , .ZN ( n980 ) ) ;
OAI21_X1 U74 (.A ( n107 ) , .B1 ( n281 ) , .B2 ( n393 ) , .ZN ( N91 ) ) ;
NAND2_X1 U75 (.A1 ( N77 ) , .A2 ( n387 ) , .ZN ( n107 ) ) ;
...
AOI222_X1 U110 (.A1 ( clk_cnt[1] ) , .A2 ( N31 ) , .B1 ( N35 ) , .B2 ( n396 ) 
    , .C1 ( n383 ) , .C2 ( cnt[1] ) , .ZN ( n490 ) ) ;
INV_X1 U111 (.A ( n51 ) , .ZN ( n207 ) ) ;
AOI222_X1 U112 (.A1 ( clk_cnt[0] ) , .A2 ( N31 ) , .B1 ( N34 ) , .B2 ( n396 ) 
    , .C1 ( n383 ) , .C2 ( cnt[0] ) , .ZN ( n51 ) ) ;
...
AND2_X1 U8 (.A1 ( scl_i ) , .A2 ( n405 ) , .ZN ( n13 ) ) ;
AND2_X1 U9 (.A1 ( sda_i ) , .A2 ( rst ) , .ZN ( n15 ) ) ;
AND2_X1 U10 (.A1 ( cSCL_0_ ) , .A2 ( n403 ) , .ZN ( n16 ) ) ;
AND2_X1 U11 (.A1 ( cSDA_0_ ) , .A2 ( n403 ) , .ZN ( n18 ) ) ;
NAND2_X1 U13 (.A1 ( n146 ) , .A2 ( rst ) , .ZN ( n820 ) ) ;
...
AND2_X1 U24 (.A1 ( n115 ) , .A2 ( ena ) , .ZN ( n970 ) ) ;
OR2_X1 U29 (.A1 ( n372 ) , .A2 ( N31 ) , .ZN ( n7 ) ) ;
NAND3_X1 U35 (.A1 ( n131 ) , .A2 ( rst ) , .A3 ( ena ) , .ZN ( n990 ) ) ;
AND2_X1 U40 (.A1 ( n22 ) , .A2 ( n370 ) , .ZN ( n3 ) ) ;
OR2_X1 U46 (.A1 ( n260 ) , .A2 ( n375 ) , .ZN ( n8 ) ) ;
...
SDFFS_X1 dSCL_reg (.D ( 1'b1 ), .SE ( n188 ) , .SI ( rst_hfs_netlink_6 ) 
    , .SN ( n366 ) , .CK ( n163 ) , .QN ( n153 ) ) ;
SDFFS_X1 dSDA_reg (.D ( 1'b1 ), .SE ( n223 ) , .SI ( n407 ) , .SN ( n366 ) 
    , .CK ( n163 ) , .QN ( n190 ) ) ;
...
NAND4_X1 U128 (.A1 ( n110 ) , .A2 ( n111 ) , .A3 ( n112 ) , .A4 ( n113 ) 
    , .ZN ( n109 ) ) ;
OAI33_X1 U160 (.A1 ( n263 ) , .A2 ( n151 ) , .A3 ( n258 ) , .B1 ( n224 ) 
    , .B2 ( n250 ) , .B3 ( n262 ) , .ZN ( n117 ) ) ;
...
module i2c_master_byte_ctrl (i2c_al , scl_o , scl_oen , sda_o , sda_oen , 
    nReset_hfs_netlink_8 , ack_in , scl_i , sda_i , VDD , VSS , 
    cmd_ack , ack_out , i2c_busy , clk , rst , nReset , ena , start , 
    stop , read , write , dout , din , clk_cnt , nReset_hfs_netlink_9 , 
    nReset_hfs_netlink_10 , nReset_hfs_netlink_11 , nReset_hfs_netlink_12 , 
    rst_hfs_netlink_13 , rst_hfs_netlink_14 , rst_hfs_netlink_15 , 
    clk_cts_0 );
output i2c_al ;
output scl_o ;
output scl_oen ;
...
i2c_master_bit_ctrl bit_controller (.dout ( core_rxd ) , 
    .scl_oen ( scl_oen ) , .sda_oen ( sda_oen ) , .nReset_hfs_netlink_0 ( n206 ) , 
    .din ( core_txd ) , .scl_i ( scl_i ) , .sda_i ( sda_i ) , .VDD ( 1'b0 ), 
    .VSS ( 1'b0 ), .cmd_ack ( core_ack ) , .busy ( i2c_busy ) , .al ( i2c_al ) , 
    .cmd ( core_cmd ) , .clk ( n158 ) , .rst ( rst ) , 
    .nReset ( nReset_hfs_netlink_8 ) , .ena ( ena ) , .clk_cnt ( clk_cnt ) , 
    .nReset_hfs_netlink_1 ( nReset_hfs_netlink_10 ) , 
    .nReset_hfs_netlink_2 ( 1'b0 ), .nReset_hfs_netlink_3 ( 1'b0 ), 
    .rst_hfs_netlink_4 ( rst_hfs_netlink_13 ) , .rst_hfs_netlink_5 ( n198 ) , 
    .rst_hfs_netlink_6 ( n199 ) , .rst_hfs_netlink_7 ( 1'b0 )) ;

BUF_X2 CTS_wb_clk_i_CTO_delay6 (.A ( n157 ) , .Z ( CTS_wb_clk_i_CTO_delay61 ) ) ;
BUF_X1 U105 (.A ( n148 ) , .Z ( n146 ) ) ;
BUF_X1 U25 (.A ( n148 ) , .Z ( n143 ) ) ;
BUF_X2 U107 (.A ( n157 ) , .Z ( n148 ) ) ;
BUF_X1 U104 (.A ( clk_cts_0 ) , .Z ( n145 ) ) ;
BUF_X1 U1 (.A ( CTS_wb_clk_i_CTO_delay61 ) , .Z ( n103 ) ) ;
BUF_X1 U26 (.A ( CTS_wb_clk_i_CTO_delay61 ) , .Z ( n144 ) ) ;
BUF_X1 U106 (.A ( CTS_wb_clk_i_CTO_delay61 ) , .Z ( n147 ) ) ;
BUF_X1 BUF_X1_G5B1I1 (.A ( n148 ) , .Z ( n148_G5B1I1 ) ) ;
BUF_X32 U117 (.A ( clk ) , .Z ( n158 ) ) ;
BUF_X32 U116 (.A ( clk ) , .Z ( n157 ) ) ;
...
NAND2_X1 U74 (.A1 ( ld ) , .A2 ( n189 ) , .ZN ( n59 ) ) ;
...
SDFFR_X1 core_txd_reg (.D ( n29 ) , .RN ( n204 ) , .SE ( n77 ) , .SI ( 1'b0 )
    , .CK ( n143 ) , .Q ( core_txd ) ) ;
SDFFR_X1 ack_out_reg (.D ( n29 ) , .RN ( n204 ) , .SE ( n35 ) , .SI ( 1'b0 )
    , .CK ( n143 ) , .Q ( ack_out ) ) ;
...
INV_X1 U10 (.A ( n139 ) , .ZN ( n137 ) ) ;
INV_X1 U11 (.A ( n60 ) , .ZN ( n197 ) ) ;
...
INV_X1 U19 (.A ( n199 ) , .ZN ( n198 ) ) ;
NOR2_X1 U22 (.A1 ( n123 ) , .A2 ( n45 ) , .ZN ( n40 ) ) ;
NAND2_X1 U23 (.A1 ( n197 ) , .A2 ( n189 ) , .ZN ( n63 ) ) ;
...
OAI221_X1 U36 (.A ( n71 ) , .B1 ( n197 ) , .B2 ( n10 ) , .C1 ( n22 ) , .C2 ( n9 ) 
    , .ZN ( n101 ) ) ;
NAND2_X1 U37 (.A1 ( din[7] ) , .A2 ( n137 ) , .ZN ( n71 ) ) ;
OAI221_X1 U38 (.A ( n50 ) , .B1 ( n196 ) , .B2 ( n11 ) , .C1 ( n22 ) 
    , .C2 ( n10 ) , .ZN ( n86 ) ) ;
NAND2_X1 U39 (.A1 ( din[6] ) , .A2 ( n137 ) , .ZN ( n50 ) ) ;
OAI221_X1 U40 (.A ( n51 ) , .B1 ( n196 ) , .B2 ( n12 ) , .C1 ( n11 ) 
    , .C2 ( n22 ) , .ZN ( n87 ) ) ;
NAND2_X1 U41 (.A1 ( din[5] ) , .A2 ( n137 ) , .ZN ( n51 ) ) ;
OAI221_X1 U42 (.A ( n52 ) , .B1 ( n135 ) , .B2 ( n13 ) , .C1 ( n23 ) 
    , .C2 ( n12 ) , .ZN ( n88 ) ) ;
NAND2_X1 U43 (.A1 ( din[4] ) , .A2 ( n134 ) , .ZN ( n52 ) ) ;
OAI221_X1 U44 (.A ( n53 ) , .B1 ( n135 ) , .B2 ( n14 ) , .C1 ( n23 ) 
    , .C2 ( n13 ) , .ZN ( n89 ) ) ;
NAND2_X1 U45 (.A1 ( din[3] ) , .A2 ( n134 ) , .ZN ( n53 ) ) ;
OAI221_X1 U46 (.A ( n54 ) , .B1 ( n135 ) , .B2 ( n15 ) , .C1 ( n23 ) 
    , .C2 ( n14 ) , .ZN ( n90 ) ) ;
NAND2_X1 U47 (.A1 ( din[2] ) , .A2 ( n134 ) , .ZN ( n54 ) ) ;
OAI221_X1 U48 (.A ( n55 ) , .B1 ( n135 ) , .B2 ( n16 ) , .C1 ( n23 ) 
    , .C2 ( n15 ) , .ZN ( n91 ) ) ;
NAND2_X1 U49 (.A1 ( din[1] ) , .A2 ( n134 ) , .ZN ( n55 ) ) ;
OAI221_X1 U50 (.A ( n56 ) , .B1 ( n114 ) , .B2 ( n196 ) , .C1 ( n22 ) 
    , .C2 ( n16 ) , .ZN ( n92 ) ) ;
INV_X1 U51 (.A ( core_rxd ) , .ZN ( n114 ) ) ;
NAND2_X1 U52 (.A1 ( din[0] ) , .A2 ( n137 ) , .ZN ( n56 ) ) ;
OAI221_X1 U53 (.A ( n59 ) , .B1 ( dcnt_1_ ) , .B2 ( n62 ) , .C1 ( n120 ) 
    , .C2 ( n19 ) , .ZN ( n94 ) ) ;
INV_X1 U6 (.A ( n139 ) , .ZN ( n134 ) ) ;
INV_X1 U4 (.A ( n199 ) , .ZN ( n189 ) ) ;
OR3_X1 U5 (.A1 ( ld ) , .A2 ( rst_hfs_netlink_14 ) , .A3 ( n30 ) , .ZN ( n135 ) ) ;
NAND2_X1 U18 (.A1 ( ld ) , .A2 ( n189 ) , .ZN ( n139 ) ) ;
CLKBUF_X1 U21 (.A ( nReset ) , .Z ( n200 ) ) ;
CLKBUF_X1 U108 (.A ( nReset ) , .Z ( n201 ) ) ;
CLKBUF_X1 U109 (.A ( nReset ) , .Z ( n202 ) ) ;
CLKBUF_X1 U110 (.A ( nReset_hfs_netlink_9 ) , .Z ( n203 ) ) ;
CLKBUF_X1 U111 (.A ( nReset_hfs_netlink_9 ) , .Z ( n204 ) ) ;
CLKBUF_X1 U112 (.A ( nReset_hfs_netlink_9 ) , .Z ( n205 ) ) ;
CLKBUF_X1 U113 (.A ( nReset_hfs_netlink_9 ) , .Z ( n206 ) ) ;
INV_X1 U9 (.A ( n60 ) , .ZN ( n196 ) ) ;
CLKBUF_X1 U20 (.A ( rst_hfs_netlink_14 ) , .Z ( n199 ) ) ;
endmodule
...
i2c_master_byte_ctrl byte_controller (.i2c_al ( i2c_al ) , 
    .scl_oen ( scl_padoen_o ) , .sda_oen ( sda_padoen_o ) , 
    .nReset_hfs_netlink_8 ( n306 ) , .ack_in ( cr[3] ) , .scl_i ( scl_pad_i ) , 
    .sda_i ( sda_pad_i ) , .VDD ( 1'b0 ), .VSS ( 1'b0 ), .cmd_ack ( done ) , 
    .ack_out ( irxack ) , .i2c_busy ( sr[6] ) , .clk ( n193 ) , .rst ( n329 ) , 
    .nReset ( n324 ) , .ena ( n148 ) , .start ( cr[7] ) , .stop ( cr[6] ) , 
    .read ( cr[5] ) , .write ( cr[4] ) , .dout ( rxr ) , .din ( txr ) , 
    .clk_cnt ( prer ) , .nReset_hfs_netlink_9 ( n320 ) , 
    .nReset_hfs_netlink_10 ( n311 ) , .nReset_hfs_netlink_11 ( 1'b0 ), 
    .nReset_hfs_netlink_12 ( 1'b0 ), .rst_hfs_netlink_13 ( n307 ) , 
    .rst_hfs_netlink_14 ( n301 ) , .rst_hfs_netlink_15 ( 1'b0 ), 
    .clk_cts_0 ( n193_G3B1I1 ) ) ;

BUF_X1 CTS_wb_clk_i_CTO_delay7 (.A ( n193 ) , .Z ( CTS_wb_clk_i_CTO_delay71 ) ) ;
BUF_X1 U69 (.A ( n108 ) , .Z ( n207 ) ) ;
BUF_X2 U42 (.A ( n108 ) , .Z ( n170 ) ) ;
BUF_X2 U1 (.A ( n108 ) , .Z ( n44 ) ) ;
BUF_X1 CTS_wb_clk_i_CTO_delay4 (.A ( wb_clk_i ) 
    , .Z ( CTS_wb_clk_i_CTO_delay41 ) ) ;
BUF_X1 BUF_X2_G2B1I2 (.A ( wb_clk_i ) , .Z ( n57_G2B1I2 ) ) ;
BUF_X1 U3 (.A ( n58 ) , .Z ( n42 ) ) ;
BUF_X1 U43 (.A ( n58 ) , .Z ( n180 ) ) ;
BUF_X1 U72 (.A ( n58 ) , .Z ( n218 ) ) ;
BUF_X1 U73 (.A ( n58 ) , .Z ( n219 ) ) ;
BUF_X1 U71 (.A ( n57_G2B1I1 ) , .Z ( n217 ) ) ;
BUF_X1 U44 (.A ( n192 ) , .Z ( n182 ) ) ;
BUF_X1 U67 (.A ( n192 ) , .Z ( n205 ) ) ;
BUF_X1 U2 (.A ( n192 ) , .Z ( n43 ) ) ;
BUF_X1 U68 (.A ( n192 ) , .Z ( n206 ) ) ;
BUF_X2 U54 (.A ( n57_G2B1I2 ) , .Z ( n192 ) ) ;
BUF_X2 U70 (.A ( n108 ) , .Z ( n208 ) ) ;
BUF_X2 U32 (.A ( n57_G2B1I2 ) , .Z ( n108 ) ) ;
...
BUF_X2 U25 (.A ( wb_clk_i_G1B1I1 ) , .Z ( n58 ) ) ;
BUF_X2 BUF_X1_G1B5I1 (.A ( wb_clk_i ) , .Z ( wb_clk_i_G1B1I1 ) ) ;
BUF_X1 BUF_X1_G1B3I1 (.A ( wb_clk_i_G1B1I1 ) , .Z ( wb_clk_i_G1B2I1 ) ) ;
BUF_X1 BUF_X1_G1B1I1 (.A ( wb_clk_i_G1B2I1 ) , .Z ( wb_clk_i_G1B3I1 ) ) ;
BUF_X1 BUF_X1_G3B1I1 (.A ( n193_G3B1I1 ) , .Z ( n193_G3B2I1 ) ) ;
BUF_X32 U55 (.A ( wb_clk_i ) , .Z ( n193 ) ) ;
...
OAI211_X1 U268 (.A ( n107 ) , .B ( n1080 ) , .C1 ( n332 ) , .C2 ( n35 ) 
    , .ZN ( N431 ) ) ;
AOI222_X1 U269 (.A1 ( rxr[2] ) , .A2 ( n157 ) , .B1 ( n103 ) , .B2 ( cr[2] ) 
    , .C1 ( n104 ) , .C2 ( txr[2] ) , .ZN ( n1080 ) ) ;
AOI22_X1 U270 (.A1 ( ctr[2] ) , .A2 ( n164 ) , .B1 ( prer[10] ) , .B2 ( n330 ) 
    , .ZN ( n107 ) ) ;
OAI211_X1 U271 (.A ( n105 ) , .B ( n106 ) , .C1 ( n332 ) , .C2 ( n34 ) 
    , .ZN ( N441 ) ) ;
AOI222_X1 U272 (.A1 ( rxr[3] ) , .A2 ( n158 ) , .B1 ( n103 ) , .B2 ( cr[3] ) 
    , .C1 ( n104 ) , .C2 ( txr[3] ) , .ZN ( n106 ) ) ;
AOI22_X1 U273 (.A1 ( ctr[3] ) , .A2 ( n163 ) , .B1 ( prer[11] ) , .B2 ( n331 ) 
    , .ZN ( n105 ) ) ;
OAI211_X1 U274 (.A ( n101 ) , .B ( n102 ) , .C1 ( n332 ) , .C2 ( n33 ) 
    , .ZN ( N45 ) ) ;
AOI222_X1 U275 (.A1 ( rxr[4] ) , .A2 ( n158 ) , .B1 ( n103 ) , .B2 ( cr[4] ) 
    , .C1 ( n104 ) , .C2 ( txr[4] ) , .ZN ( n102 ) ) ;
...
NOR2_X1 U286 (.A1 ( n290 ) , .A2 ( n1150 ) , .ZN ( N1081 ) ) ;
...
AND2_X1 U132 (.A1 ( irxack ) , .A2 ( n291 ) , .ZN ( n151 ) ) ;
...
AND2_X1 U141 (.A1 ( n312 ) , .A2 ( n89 ) , .ZN ( n90 ) ) ;
...
OAI33_X1 U126 (.A1 ( n420 ) , .A2 ( n325 ) , .A3 ( n67 ) , .B1 ( n72 ) 
    , .B2 ( n222 ) , .B3 ( n303 ) , .ZN ( n123 ) ) ;
...
DFFR_X1 txr_reg_0_ (.D ( n132 ) , .RN ( n292 ) , .CK ( n170 ) , .Q ( txr[0] ) 
    , .QN ( n29 ) ) ;
INV_X1 U22 (.A ( n85 ) , .ZN ( n296 ) ) ;
INV_X1 U23 (.A ( n303 ) , .ZN ( n297 ) ) ;
INV_X1 U24 (.A ( n191 ) , .ZN ( n56 ) ) ;
CLKBUF_X1 U19 (.A ( n309 ) , .Z ( n293 ) ) ;
CLKBUF_X1 U20 (.A ( n310 ) , .Z ( n294 ) ) ;
CLKBUF_X1 U18 (.A ( n302 ) , .Z ( n292 ) ) ;
INV_X1 U17 (.A ( n326 ) , .ZN ( n291 ) ) ;
CLKBUF_X1 U15 (.A ( n300 ) , .Z ( n289 ) ) ;
CLKBUF_X1 U16 (.A ( n300 ) , .Z ( n290 ) ) ;
CLKBUF_X1 U28 (.A ( n68 ) , .Z ( n299 ) ) ;
CLKBUF_X1 U29 (.A ( n189 ) , .Z ( n61 ) ) ;
CLKBUF_X1 U31 (.A ( wb_rst_i ) , .Z ( n300 ) ) ;
CLKBUF_X1 U33 (.A ( wb_rst_i ) , .Z ( n301 ) ) ;
CLKBUF_X1 U34 (.A ( n308 ) , .Z ( n302 ) ) ;
CLKBUF_X1 U35 (.A ( n66 ) , .Z ( n303 ) ) ;
CLKBUF_X1 U37 (.A ( n300 ) , .Z ( n305 ) ) ;
AND2_X1 U38 (.A1 ( n296 ) , .A2 ( n297 ) , .ZN ( n161 ) ) ;
AND2_X1 U39 (.A1 ( n296 ) , .A2 ( n297 ) , .ZN ( n162 ) ) ;
INV_X1 U40 (.A ( n191 ) , .ZN ( n168 ) ) ;
CLKBUF_X1 U45 (.A ( wb_rst_i ) , .Z ( n307 ) ) ;
CLKBUF_X1 U46 (.A ( arst_i ) , .Z ( n308 ) ) ;
CLKBUF_X1 U47 (.A ( arst_i ) , .Z ( n309 ) ) ;
NAND3_X1 U51 (.A1 ( wb_ack_o ) , .A2 ( n291 ) , .A3 ( wb_we_i ) , .ZN ( n189 ) ) ;
OR2_X1 U52 (.A1 ( n295 ) , .A2 ( n61 ) , .ZN ( n190 ) ) ;
OR2_X1 U53 (.A1 ( n295 ) , .A2 ( n61 ) , .ZN ( n191 ) ) ;
CLKBUF_X1 U57 (.A ( n309 ) , .Z ( n314 ) ) ;
CLKBUF_X1 U58 (.A ( n309 ) , .Z ( n315 ) ) ;
CLKBUF_X1 U59 (.A ( n302 ) , .Z ( n316 ) ) ;
CLKBUF_X1 U60 (.A ( n308 ) , .Z ( n317 ) ) ;
CLKBUF_X1 U61 (.A ( n309 ) , .Z ( n318 ) ) ;
CLKBUF_X1 U62 (.A ( n308 ) , .Z ( n319 ) ) ;
CLKBUF_X1 U63 (.A ( n308 ) , .Z ( n320 ) ) ;
CLKBUF_X1 U64 (.A ( n311 ) , .Z ( n321 ) ) ;
CLKBUF_X1 U65 (.A ( n310 ) , .Z ( n322 ) ) ;
CLKBUF_X1 U66 (.A ( n310 ) , .Z ( n323 ) ) ;
INV_X1 U36 (.A ( n305 ) , .ZN ( n304 ) ) ;
CLKBUF_X1 U48 (.A ( arst_i ) , .Z ( n310 ) ) ;
CLKBUF_X1 U49 (.A ( arst_i ) , .Z ( n311 ) ) ;
INV_X1 U50 (.A ( n303 ) , .ZN ( n312 ) ) ;
INV_X1 U56 (.A ( n77 ) , .ZN ( n313 ) ) ;
CLKBUF_X1 U76 (.A ( n307 ) , .Z ( n326 ) ) ;
INV_X1 U83 (.A ( n75 ) , .ZN ( n333 ) ) ;
INV_X1 U27 (.A ( n77 ) , .ZN ( n298 ) ) ;
INV_X1 U21 (.A ( n75 ) , .ZN ( n295 ) ) ;
AND2_X1 U30 (.A1 ( n296 ) , .A2 ( n297 ) , .ZN ( n250 ) ) ;
CLKBUF_X1 U41 (.A ( n321 ) , .Z ( n306 ) ) ;
CLKBUF_X1 U74 (.A ( n310 ) , .Z ( n324 ) ) ;
CLKBUF_X1 U75 (.A ( n300 ) , .Z ( n325 ) ) ;
INV_X1 U77 (.A ( n326 ) , .ZN ( n327 ) ) ;
INV_X1 U78 (.A ( n305 ) , .ZN ( n328 ) ) ;
INV_X1 U79 (.A ( n305 ) , .ZN ( n329 ) ) ;
INV_X1 U80 (.A ( n85 ) , .ZN ( n330 ) ) ;
INV_X1 U81 (.A ( n85 ) , .ZN ( n331 ) ) ;
INV_X1 U82 (.A ( n75 ) , .ZN ( n332 ) ) ;
